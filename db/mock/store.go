...
// Source: github.com/vsevicky/simplebank/db/sqlc (interfaces: Store)
...
// UpdateFetchAccount mocks base method.
func (m *MockStore) UpdateFetchAccount(arg0 context.Context, arg1 db.UpdateFetchAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateFetchAccount", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateFetchAccount indicates an expected call of UpdateFetchAccount.
func (mr *MockStoreMockRecorder) UpdateFetchAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateFetchAccount", reflect.TypeOf((*MockStore)(nil).UpdateFetchAccount), arg0, arg1)
}
